...
<section class="section">
  <div class="container">
    <div class="grid">
      ...
      {% endcapture %}
      {% include card.html class="card--12" icon="i-phone" eyebrow="Contact" title="Details" content=c1 %}
      ...
      {% endcapture %}
      {% include card.html class="card--12" icon="i-calendar" eyebrow="Schedule" title="Book time" content=cal %}
